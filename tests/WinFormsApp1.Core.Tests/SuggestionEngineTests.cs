...
public sealed class SuggestionEngineTests
{
    ...
    public void ElixirNotEnough_NoSuggestion()
    {
        ...
        var s1 = engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0);
        var s2 = engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0.AddMilliseconds(100));
    ...
    public void RightThreat_PicksRightDefense()
    {
        ...
        var t0 = new DateTime(2020, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0);
        var suggestion = engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0.AddMilliseconds(200));
    ...
    public void CooldownBlocksRapidRepeat()
    {
        ...
        var t0 = new DateTime(2020, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0);
        var first = engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0.AddMilliseconds(200));
        var second = engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0.AddMilliseconds(400));
    ...
    public void CooldownAfterSuggestion_RequiresNewStreak()
    {
        ...
        var afterCooldown = engine.Decide(motion, elixir, hand, EnemyState.Empty, Array.Empty<SpawnEvent>(), MatchClockState.Unknown, t0.AddMilliseconds(900));
    ...
    public void EnemySpawnActsAsDefenseTrigger()
    {
        ...
        engine.Decide(motion, elixir, hand, EnemyState.Empty, new[] { spawn }, MatchClockState.Unknown, t0);
        var suggestion = engine.Decide(motion, elixir, hand, EnemyState.Empty, new[] { spawn }, MatchClockState.Unknown, t0.AddMilliseconds(200));
